    ...
    const projectElement = `
            ...
            <div class="md:w-3/5 lg:1/2">
                ...
                <div class="text-start  md:mt-0 md:w-2/5 lg:1/2">
                    ...
                    <h2 class="text-md text-cyan-500 lg:text-2xl">${project.subtitle}</h2>
                    <h6 class="text-xs md:text-base ">${project.description}</h6>
                    <div class="mt-3 text-xs lg:text-xs flex gap-3">
                    <a class="p-2 lg:p-3 bg-cyan-500 text-gray-50 outline outline-2 outline-cyan-800 rounded-full " href="${project.link}"><button>Visit Now</button></a>
                    <a class="p-2 lg:p-3  bg-gray-950 dark:bg-gray-50  text-gray-50 dark:text-gray-950 rounded-full outline outline-2 dark:outline-cyan-500 outline-cyan-800" href="${project.link2}">Refrences</a>
                    </div>
                </div>
            </div>
        `;
